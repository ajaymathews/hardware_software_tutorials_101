/* 
 * Tutorial: 10_Inheritance_Types.cpp
...
c.set_p_age(101); //in this the value passed/ recieved by each object is different,
p.set_p_age(102); //value passd by c object cant be retrieved by p object, 
                  //bcz both save in different locations in memory
c.set_s_age(51);
c.set_d_age(41);
c.set_c_age(11);
cout<<"using object"<<endl;
cout<<"parent(c object):"<<c.get_p_age()<<endl;
cout<<"parent(p object):"<<p.get_p_age()<<endl;
