/*
	COUNT IS INCREMENTED, WHEN EXECUTING EACH TASK, AS IN TASK0, COUNT0 IS incrementED TO 1, THEN IT EXECUTES THE THREADYIELD FUNCTION
  AND THUS THE SYSTICK INTERRUPT IS CALLED, WHEN UPON CLLING THE SYSTICK INTERRUPT ,WE HAVE CONFIGURED TO EXECUTE CONTEXT SWITCHING 
	AND THE TASK SWITCHING. THUS 2ND TASK IS EXECUTED AND THE SAME ALSO TAKES PLACE THERE.
	WHICH MEANS THAT EACH TASK IS ALLOTED A TIME OF  1/10000 mS
	*/
