...
updater.dispatcher.add_handler(CommandHandler('Button2', Button2))
updater.dispatcher.add_handler(CommandHandler('Button3', Button3))
updater.dispatcher.add_handler(CommandHandler('Button4', Button4))
updater.dispatcher.add_handler(CommandHandler('Button5', Button5))
updater.dispatcher.add_handler(CommandHandler('Button6', Button6))
